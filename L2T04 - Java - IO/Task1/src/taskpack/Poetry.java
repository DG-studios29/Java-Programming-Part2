...
public class Poetry {
    ...
    public static void main(String[] args) {
        ...
        String outputFileName = "encodedPoem.txt";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(inputFileName));
            ...
            while ((line = br.readLine()) != null) {
                // Encode each line and write the encoded line to the output file
                String encodedLine = encodeMessage(line);
                bw.write(encodedLine);
                bw.newLine(); // Add a new line for each line in the original poem
            }

            System.out.println("Encoding completed. Check " + outputFileName + " for the encoded poem.");
